...
class SimplifierTest(unittest.TestCase):
    ...
    def testNamedAnchor(self):
        # named anchors should be left alone (ie. treated just like any inline element)
        self.assertEqual(simplify('<h3><a name="link_to_here"><word pos="adjective">red</word></a></h3>', 'en'),
            '<h3><a name="link_to_here"><span class="anno" data-entry="93a2b8b9bcbece6ea8b0d1a3b09394c9d6990174">red</span></a></h3>')
